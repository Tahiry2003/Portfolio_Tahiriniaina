      ...
      <div className="max-w-7xl mx-auto w-full px-6 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 flex items-center space-x-2">
            <button className="hidden md:block bg-primary text-white px-6 py-3 font-semibold hover:opacity-90 transition">
              Me contacter
            </button>
            <button className="hidden md:block bg-primary text-white px-6 py-3 font-semibold hover:opacity-90 transition">
              Voir mes projets
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative">
            ...
            <span className="absolute top-16 -right-20 flex items-center gap-2 
            bg-white/80 backdrop-blur-md px-4 py-2 text-sm rounded-full shadow-lg
            hover:scale-110 transition">
              <Atom size={16} className="text-blue-500" /> React
            </span>

            <span className="absolute -bottom-20 left-16 flex items-center gap-2 
            bg-white/80 backdrop-blur-md px-4 py-2 text-sm rounded-full shadow-lg
            hover:scale-110 transition">
              <Braces size={16} className="text-yellow-500" /> JavaScript
            </span>

            <span className="absolute bottom-16 -right-16 flex items-center gap-2 
            bg-white/80 backdrop-blur-md px-4 py-2 text-sm rounded-full shadow-lg
            hover:scale-110 transition">
